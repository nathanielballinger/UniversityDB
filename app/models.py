...
class Character(db.Model):
	...
	def serialize_table(self):
		fields = {"id": self.id, "gender": gender, "name": self.name, "aliases": self.aliases, "first_appeared_in_game": self.first_appeared_in_game, "deck": self.deck, "tiny_image": self.tiny_image}
		return fields
