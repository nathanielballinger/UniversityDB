...
platform2URL = "http://www.giantbomb.com/api/platform/2/?api_key="+api_key+"&format=json"+platformFieldList
platform3URL = "http://www.giantbomb.com/api/platform/3/?api_key="+api_key+"&format=json"+platformFieldList
